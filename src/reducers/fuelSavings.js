import {SAVE_DEPUTADOS, SAVE_DEPUTADO, FILTER_COMISSAO_PARLAMENTAR, SHOW_TODOS_PARLAMENTARES} from '../constants/ActionTypes';
...
export default function fuelSavingsAppState(state = initialState, action) {
	switch (action.type) {
      ...
      // In a real app using Redux, you might use redux-thunk and handle the async call in fuelSavingsActions.js
			return objectAssign({}, state, { data: action.data, filteredParlamentar: action.data });
    case SAVE_DEPUTADO:
